...
Partial Public NotInheritable Class SapCoAbcAddIn
...
Partial Friend NotInheritable Class Globals
    ...
    Private Shared _SapCoAbcAddIn As SapCoAbcAddIn
    ...
    Friend Shared Property SapCoAbcAddIn() As SapCoAbcAddIn
        Get
            Return _SapCoAbcAddIn
        End Get
        Set
            If (_SapCoAbcAddIn Is Nothing) Then
                _SapCoAbcAddIn = value
            Else
